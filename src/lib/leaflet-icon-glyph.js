...
// 		bgPos: (Point)
        ...
        glyphAnchor: [0, -10]	// In pixels, counting from the center of the image.
    },
    ...
    _getIconUrl: function (name) {
        if (name === 'icon') {
            ...
            const svg = `
<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="${color}" class="bi bi-geo-fill" viewBox="0 0 16 16">
